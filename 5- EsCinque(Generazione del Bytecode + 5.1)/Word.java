/* Word è derivata da token ed rappreseneta i token che corrispondono: 
 identificatori, parole chiavi, operatori relazioni e elementi di sinatassi 
che consistono di piu caratteri (es &&) */ 
